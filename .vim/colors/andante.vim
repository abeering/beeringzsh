...
hi Visual	term=bold,reverse cterm=bold,reverse ctermfg=gray ctermbg=black gui=bold,reverse guifg=gray40 guibg=white
...
hi StatusLine	term=reverse cterm=reverse gui=reverse guifg=black guibg=gray60
hi StatusLineNC	term=reverse cterm=reverse gui=reverse guifg=black guibg=gray60
